    ...
    <nav class="container min-w-screen flex justify-center bg-Homepage-navbar border-b-3 border-yellow-500 ">
        <div class="container flex justify-between mx-5 text-white">
            ...
            <div class="flex items-center">
                ...
                <a class="md:m-4 m-2 rounded-xl py-2 max-[400px]:py-1 px-5 max-[400px]:px-1 bg-yellow-500 text-xl" href="/Blackjackpagexxxx">play now</a>
                <a class="hidden sm:block md:m-4 m-2 text-yellow-500" href="#">LeaderBoard</a>
            </div>
            <div class="flex items-center gap-3.5">
                <a class="hidden sm:block text-yellow-500" href="/register">sign up</a>
                <a class="hidden sm:block text-yellow-500" href="/login">login</a>
            </div>

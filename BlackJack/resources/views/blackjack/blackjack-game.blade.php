            ...
            <div class="container flex justify-center flex-col">
                <div class="container flex justify-center">
                    <div class="container flex justify-center relative w-fit" id="userChipBetContainer">
                        <img src="http://127.0.0.1:8000/image/Chips/1000.png" class="ChipImgSize">
                        <img src="http://127.0.0.1:8000/image/Chips/1000.png" class="ChipImgSize absolute top-0.4 left-2.1  transform rotate-5.4">
                    </div>
                </div>

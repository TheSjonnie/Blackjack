<x-home-layout>
    <div class="relative w-full min-h-screen flex flex-col justify-center ">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center gap-20 mt-[5%]">
            ...
            <div class="flex flex-col gap-10 items-center">
                ...
                <div class="grid grid-flow-col md:grid-rows-1 grid-rows-3 gap-4 text-lg">
                    <div class="border-1 border-amber-500/60 rounded-lg p-5 bg-black/20 flex flex-col items-center transition-all duration-300 hover:scale-110 active:scale-100">
                        <h1 class="text-amber-500">99,5%</h1>
                        <h1 class="text-white/80">Uitbetaling percentage</h1>
                    </div>
                    <div class="border-1 border-amber-500/60 rounded-lg p-5 bg-black/20 flex flex-col items-center transition-all duration-300 hover:scale-110 active:scale-100">
                        <h1 class="text-amber-500">24/7</h1>
                        <h1 class="text-white/80">Beschikbaar</h1>
                    </div>
                    <div class="border-1 border-amber-500/60 rounded-lg p-5 bg-black/20 flex flex-col items-center transition-all duration-300 hover:scale-110 active:scale-100">
                        <h1 class="text-amber-500">∞</h1>
                        <h1 class="text-white/80">onbeperkt spelen</h1>
                    </div>
                </div>
            </div>
        </div>
